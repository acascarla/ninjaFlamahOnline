...
var Server = function() {
    ...
    this.updatePlayerInServer = function(player){
        if (player.id == 'Player1'){
            ...
            mPlayer1.killsInterfaceUpdatedOtherClient = player.killsInterfaceUpdatedOtherClient;
            ...
            mPlayer2.killsInterfaceUpdatedOtherClient = player.killsInterfaceUpdatedOtherClient;
